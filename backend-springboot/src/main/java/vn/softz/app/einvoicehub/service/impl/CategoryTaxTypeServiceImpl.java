...
/**
 * Triển khai {@link CategoryTaxTypeService}.
 *
 * <p>Catalog danh mục Loại thuế – dữ liệu ít thay đổi, phù hợp cache tầng trên nếu cần.
 *
 * <h3>Validate nghiệp vụ khi tạo mới</h3>
 * <ol>
 *   <li>{@code taxName} chưa tồn tại (unique).
 *   <li>{@code vat} ∈ {null, 0, 3.5, 5, 7, 8, 10} – khớp DB constraint.
 * </ol>
 */
@Slf4j
@Service
