...
/**
 * Mapping Loại tham chiếu hóa đơn Hub ↔ NCC ({@code einv_mapping_reference_type}).
 *
 * <p>Loại tham chiếu xác định quan hệ giữa các hóa đơn:
 * <pre>
 *   Hub referenceTypeId ↔ NCC providerReferenceTypeId
 *   0 (Gốc)            ↔ BKAV: "0"      | MobiFone: "ORIGIN"
 *   2 (Điều chỉnh)     ↔ BKAV: "1"      | MobiFone: "ADJUST"
 *   3 (Thay thế)       ↔ BKAV: "2"      | MobiFone: "REPLACE"
 * </pre>
 *
 * <p>Mapping này được dùng khi build payload hóa đơn điều chỉnh/thay thế
 * gửi lên NCC (trường {@code referenceType} trong request XML/JSON).
 */
@Slf4j
@Service
