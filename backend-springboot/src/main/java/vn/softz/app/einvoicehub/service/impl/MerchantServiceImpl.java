...
/**
 * Triển khai {@link MerchantService}.
 *
 * <h3>tenantId là trái tim của hệ thống multi-tenant</h3>
 * <p>{@code tenantId} là UUID bất biến, được dùng làm foreign key trong
 * <em>mọi</em> bảng dữ liệu. Một khi được tạo, không được thay đổi dù
 * tên công ty hay MST có thể đổi.
 *
 * <h3>Deactivate cascades</h3>
 * <p>Khi deactivate Merchant, toàn bộ Store thuộc Merchant cũng bị
 * deactivate để đảm bảo không có data hoạt động khi tenant bị khoá.
 */
@Slf4j
@Service
...
public class MerchantServiceImpl implements MerchantService {
    ...
    public void deactivate(Long id) {
        ...
        // Cascade: deactivate tất cả Store thuộc Merchant
