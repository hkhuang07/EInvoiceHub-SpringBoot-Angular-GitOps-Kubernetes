...
import com.einvoicehub.core.domain.entity.InvoiceMetadataEntity;
...
public interface InvoiceMetadataRepository
        extends JpaRepository<InvoiceMetadataEntity, Long>, JpaSpecificationExecutor<InvoiceMetadataEntity> {

    Page<InvoiceMetadataEntity> findByMerchantIdAndIsDeletedFalse(Long merchantId, Pageable pageable);

    List<InvoiceMetadataEntity> findByMerchantIdAndStatus(Long merchantId, InvoiceStatus status);

    Optional<InvoiceMetadataEntity> findByIdAndIsDeletedFalse(Long id);

    Optional<InvoiceMetadataEntity> findByMerchantIdAndClientRequestId(Long merchantId, String clientRequestId);

    Optional<InvoiceMetadataEntity> findByInvoiceNumberAndIsDeletedFalse(String invoiceNumber);

    List<InvoiceMetadataEntity> findByMerchantIdAndIssueDateBetween(
            Long merchantId, LocalDate fromDate, LocalDate toDate);

    List<InvoiceMetadataEntity> findByMerchantIdAndCreatedAtBetween(
    ...
    List<InvoiceMetadataEntity> findByMerchantAndStatuses(
    ...
    Page<InvoiceMetadataEntity> findByMerchantAndBuyerTaxCode(
            @Param("merchantId") Long merchantId,
    ...
    Page<InvoiceMetadataEntity> searchByKeyword(
            @Param("merchantId") Long merchantId,
    ...
    List<InvoiceMetadataEntity> findPendingInvoicesOlderThan(
            @Param("merchantId") Long merchantId,
            @Param("status") InvoiceStatus status,
    ...
    List<InvoiceMetadataEntity> findByMerchantAndProvider(
            @Param("merchantId") Long merchantId,
