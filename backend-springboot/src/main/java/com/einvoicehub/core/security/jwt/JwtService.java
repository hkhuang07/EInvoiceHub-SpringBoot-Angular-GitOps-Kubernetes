...
public class JwtService {
    ...
    public String generateToken(SecurityUser userDetails) {
        ...
        // Logic SOFTZ: Lưu MerchantID vào Token để các Request sau không cần query DB lại
        extraClaims.put("MerchantID", userDetails.getMerchantId());
    ...
    private Claims extractAllClaims(String token) {
        return Jwts.parser()
                .verifyWith((javax.crypto.SecretKey) getSignInKey()) // Ép kiểu về SecretKey cho bản 0.12.x
                .build()
