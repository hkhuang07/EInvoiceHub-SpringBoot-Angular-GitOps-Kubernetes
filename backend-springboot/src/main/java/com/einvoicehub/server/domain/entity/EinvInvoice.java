...
@Table(name = "einv_invoices", 
       ...
       uniqueConstraints = {
           @UniqueConstraint(name = "uq_biz_invoice", columnNames = {"store_id", "partner_invoice_id"})
       })
public class EinvInvoice extends BaseEntity {
    ...
    private List<EinvInvoiceDetail> details = new ArrayList<>();
    ...
    public List<EinvInvoiceDetail> getDetails() {
        return details;
    }

    public void setDetails(List<EinvInvoiceDetail> details) {
        this.details = details;
    }

    /**
     * Helper method để thêm chi tiết hóa đơn
     */
    public void addDetail(EinvInvoiceDetail detail) {
        details.add(detail);
        detail.setInvoice(this);
    }

    /**
     * Helper method để xóa chi tiết hóa đơn
     */
    public void removeDetail(EinvInvoiceDetail detail) {
