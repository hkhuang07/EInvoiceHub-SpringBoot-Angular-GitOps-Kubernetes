...
public class EinvMappingReferenceTypeDto {
    ...
    @NotNull(message = "Reference type ID is required")
    private Byte referenceTypeId;

    @JsonProperty("provider_reference_type_id")
    @NotBlank(message = "Provider reference type ID is required")
    @Size(max = 36, message = "Provider reference type ID must not exceed 36 characters")
