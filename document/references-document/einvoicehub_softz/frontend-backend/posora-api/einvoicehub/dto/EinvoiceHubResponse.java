...
public class EinvoiceHubResponse<T> {
    ...
    public static <T> EinvoiceHubResponse<T> alreadyExists(String message) {
    ...
    public static <T> EinvoiceHubResponse<T> notFound(String requestId, String message) {
        return error(requestId, "404", message);
    }
